...
int main()
{
    ...
    for (int i = 0; i < 6; ++i)
    {
        string filename = "C:\\Users\\Admin\\Desktop\\Graphic\\Image\\face_" + to_string(i + 1) + ".jpg";
    ...
    if (!backgroundTexture.loadFromFile("C:\\Users\\Admin\\Desktop\\Graphic\\Image\\14.jpg"))
    {
